...
export const heroData = {
  pretitle: 'Your Daily Dose of Delight!',
...
export const menuData = {
  title: 'Rich Flavour In Every Cup',
  subtitle: 'Explore Our Menu For Delightful Brew Today',
...
export const footerData = {
  contact: {
    ...
    address: '3784 Sahloul Sousse, Tunisia',
    phone: '(201)256-3689',
  },
  hours: {
    title: 'working hours',
